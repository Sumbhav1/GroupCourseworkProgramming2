    ...
    <div className="flex items-center justify-center h-screen bg-blue-300">
      <div className="bg-blue-200 p-10 rounded-lg shadow-lg w-96 text-center max-h-screen overflow-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="text-left">
            <label className="block font-medium">How many meals do you (typically) eat per day?</label>
            <input
              type="number"
              value={meals}
          ...
          <div className="text-left">
            <label className="block font-medium">Receive reminders to log sleep?</label>
          ...
          <div className="text-left">
            <label className="block font-medium">Receive reminders to log meals?</label>
            <div className="flex space-x-4">
              <label className="inline-flex items-center">
                <input
                  type="radio"
